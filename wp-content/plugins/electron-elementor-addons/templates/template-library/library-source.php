...
* Library api class
*
* @package ElectronAddons
* @author ElectronMonster
*/
...
class Library_Source extends Source_Base {
    ...
    */
    const LIBRARY_CACHE_KEY = 'electron_library_cache';
    ...
    */
    const API_TEMPLATES_INFO_URL = 'https://elementories.com/electron/wp-content/template-library/info.json';

    /**
    * Template data api url
    */
    const API_TEMPLATE_DATA_URL = 'https://elementories.com/electron/wp-content/template-library/templates/';

    public function get_id() {
        return 'electron-library';
    }

    public function get_title() {
        return __( 'Electron Library', 'electron' );
    }
    ...
    */
    ...
    public static function request_template_data( $template_id ) {
        ...
        $body = [
            ...
            'version' => ELECTRON_PLUGIN_VERSION,
        ];
        /*
        if ( electron_has_pro() ) {
            $body['has_pro'] = 1;
            $body['pro_version'] = ELECTRON_PLUGIN_VERSION;
        }
        */
    ...
    */
    public function get_data( array $args, $context = 'display' ) {
        ...
        if ( empty( $data ) || empty( $data['content'] ) ) {
            throw new \Exception( __( 'Template does not have any content', 'electron' ) );
        }
