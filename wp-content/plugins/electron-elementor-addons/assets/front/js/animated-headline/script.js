!(function ($) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/electron-animated-headline.default', ntrAnimatedHeadline );
        elementorFrontend.hooks.addAction('frontend/element_ready/electron-onepage.default', ntrAnimatedHeadline);
    });
