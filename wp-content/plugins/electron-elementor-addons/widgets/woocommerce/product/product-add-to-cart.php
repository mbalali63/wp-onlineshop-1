...
class Electron_WC_Product_Add_To_Cart extends Widget_Base {

    public function get_name() {
        return 'electron-wc-product-add-to-cart';
    }
    public function get_title() {
        return esc_html__( 'Add To Cart', 'electron' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Border Radius', 'electron' ),
        ...
        $this->add_control(
            'button_bg_color',
            [
                'label' => __( 'Background Color', 'electron' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => __( 'Border Color', 'electron' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_transition',
            [
                'label' => __( 'Transition Duration', 'electron' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Select field', 'electron' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    protected function render() {
        ...
        <div class="electron-add-to-cart electron-product-<?php echo esc_attr( $product->get_type() ); ?>">
