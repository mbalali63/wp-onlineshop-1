        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    $msg = '<strong>' . esc_html__( 'The', 'electron') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'electron') . ' Redux Framework ' . esc_html__('version', 'electron') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','electron' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'electron') . ' Redux Framework ' . esc_html__('version','electron' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and features of this extension will not be available until the latest version of','electron' ) . ' Redux Framework ' . esc_html__('has been installed.','electron' );
