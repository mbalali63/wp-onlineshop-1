...
<div class="electron-summary-item electron-product-info">
	<div class="electron-product-info-top">
		<form class="electron-flex cart grouped_form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
		    ...
		    <?php if ( $quantites_required && $show_add_to_cart_button ) : ?>
		        ...
		        <div class="electron-after-cart-grouped-button-wrapper">
                ...
                <?php printf('%s', $icon ); ?>
		            ...
		            <div class="electron-after-cart-button-wrapper">
