    ...
    <div class="col-12 col-md-10 col-lg-8">
        ...
        <form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
            ...
            <p class="form-row electron-row electron-is-required">
                ...
                <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name" id="account_display_name" value="<?php echo esc_attr( $user->display_name ); ?>" /> <span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'electron' ); ?></em></span>
                <span class="electron-form-message"></span>
            </p>
            ...
            <p>
                ...
                <button type="submit" class="woocommerce-Button button" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'electron' ); ?>"><?php esc_html_e( 'Save changes', 'electron' ); ?></button>
