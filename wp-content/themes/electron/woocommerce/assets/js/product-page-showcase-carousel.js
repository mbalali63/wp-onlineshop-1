jQuery(document).ready(function($) {
    ...
    */
    ...
    var options = $('.electron-product-showcase-main').data('swiper-options');
    options['on'] = {
        ...
        'transitionEnd': function( swiper ) {
            ...
            $( '.electron-product-showcase-main .swiper-slide:not(.swiper-slide-active)' ).each(function () {
            ...
            $( '.electron-product-showcase-main .swiper-slide.swiper-slide-active' ).each(function () {
    ...
    const galleryMain = new NTSwiper( '.electron-product-showcase-main', options);
