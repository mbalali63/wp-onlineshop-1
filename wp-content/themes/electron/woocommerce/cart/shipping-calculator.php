...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <?php printf( '<a href="#0" class="electron-shipping-calculator-button">%s <div class="dropdown-btn"><span class="fas fa-angle-down"></span></div></a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'electron' ) ) ); ?>
    ...
    <div class="shipping-calculator-form" style="display:none;">
        ...
        <p><button type="submit" name="calc_shipping" value="1" class="electron-btn electron-btn-border  electron-btn-small electron-shipping-calculator-button"><?php esc_html_e( 'Update', 'electron' ); ?></button></p>
