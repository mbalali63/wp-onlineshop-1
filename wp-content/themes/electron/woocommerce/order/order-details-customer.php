...
<div class="woocommerce-customer-details">
    ...
    <?php endif; ?>
                ...
                <h4 class="woocommerce-column__title electron-section-title"><?php esc_html_e( 'Billing address', 'electron' ); ?></h4>

                <address>
                    <?php echo wp_kses_post( $order->get_formatted_billing_address( esc_html__( 'N/A', 'electron' ) ) ); ?>
    ...
    <?php if ( $show_shipping ) : ?>
            ...
            <div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col-12 col-lg-6">
                <h4 class="woocommerce-column__title electron-section-title"><?php esc_html_e( 'Shipping address', 'electron' ); ?></h4>
                <address>
                    <?php echo wp_kses_post( $order->get_formatted_shipping_address( esc_html__( 'N/A', 'electron' ) ) ); ?>
