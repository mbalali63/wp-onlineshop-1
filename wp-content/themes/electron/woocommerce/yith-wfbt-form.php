	...
	<li class="yith-wfbt-item">
		<label for="offeringID_<?php echo esc_attr( $index ); ?>">
			...
			<span class="product-name">
				<?php echo ! $index ? esc_html__( 'This Product', 'electron' ) . ': ' . esc_html( $current_product_title ) : esc_html( $current_product_title ); ?>
			</span>
...
// set button label.
$label       = get_option( 'yith-wfbt-button-label', __( 'Add all to Cart', 'electron' ) );
$label_total = get_option( 'yith-wfbt-total-label', __( 'Price for all', 'electron' ) );
$title       = get_option( 'yith-wfbt-form-title', __( 'Frequently Bought Together', 'electron' ) );//phpcs:ignore

?>

<div class="electron-yith-wfbt-section woocommerce electron-section">
	<?php
	if ( $title ) {
	...
	<form class="yith-wfbt-form" method="post" action="<?php echo esc_url( $url ); ?>">
		...
		<?php echo '<div class="yith-wfbt-images electron-yith-wfbt-images">'.$thumbs.'</div>'; ?>

		<div class="electron-yith-wfbt-block-wrapper">
			
			<?php echo '<ul class="electron-yith-wfbt-items">'.$checks.'</ul>'; ?>
			
			<div class="electron-yith-wfbt-block">
				...
				<button type="submit" class="yith-wfbt-submit-button electron-btn electron-btn-medium electron-btn-primary electron-btn-border">
